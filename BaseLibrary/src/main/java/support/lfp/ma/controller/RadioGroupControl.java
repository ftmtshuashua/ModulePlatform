 ...
 * </pre>
 */
public class RadioGroupControl<T extends RadioGroupControl.RadioItem> extends Module {
    ...
    public RadioGroupControl(ModulePlatform platform) {
        super(platform);
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mCheckedRadio != null) {
            outState.putInt("CheckedRadioResouceId", mCheckedRadio.getView().getId());
        }
    }
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            int resouceId = savedInstanceState.getInt("CheckedRadioResouceId", -1);
            if (resouceId != -1) checkById(resouceId);
        }
    }
